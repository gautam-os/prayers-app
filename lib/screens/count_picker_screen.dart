...
class _CountPickerScreenState extends State<CountPickerScreen> {
  ...
  void initState() {
    ...
    _selectedCount =
        lastCount ?? widget.prayer.presetCounts[widget.prayer.presetCounts.length ~/ 2];
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Semantics(
                        header: true,
                        label: '${widget.prayer.title} setup',
                        child: Text(
                          widget.prayer.title,
                      ...
                      Semantics(
                        button: true,
                        label: 'Enter a custom repetition count',
                      ...
                      SizedBox(
                        ...
                        child: Semantics(
                          button: true,
                          label:
                              'Start prayer with target count $_selectedCount',
    ...
    return Row(
      ...
      children: widget.prayer.presetCounts.map((count) {
        ...
        return Semantics(
          button: true,
          selected: isSelected,
          label: 'Select $count repetitions',
          child: GestureDetector(
            onTap: () {
              HapticService.tap();
